...
/**
 * Class RevolutWebhooksModel
 *
 * Represents a webhooks model to store revolut webhooks
 */
class RevolutWebhooksModel extends MainModel
{
    protected $table = '247_revolut_webhooks';

    protected $primaryKey = 'id';

    protected $allowedFields = ['email_id', 'token_validation_id', 'webhook_id', 'scope', 'destination', 'api_response'];
