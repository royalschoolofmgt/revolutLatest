 ...
 *
 * Represents a custom page model to store custom pages of bigcommerce
 */
class CustomPagesModel extends MainModel
{
    protected $table = '247custompages';

    protected $primaryKey = 'id';

    protected $allowedFields = ['email_id', 'token_validation_id', 'page_bc_id', 'api_response'];
