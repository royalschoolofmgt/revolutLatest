...
/**
 * Class CustomRevolutPayButtonModel
 *
 * Represents a model to modify layout of card information in front end
 */
class CustomRevolutPayButtonModel extends MainModel
{
    protected $table = 'custom_revolutpay_button';

    protected $primaryKey = 'id';

    protected $allowedFields = ['email_id', 'token_validation_id', 'is_enabled', 'container_id', 'css_prop', 'payment_name', 'powerby_logo', 'buttoncolor', 'textcolor', 'outlinecolor'];
